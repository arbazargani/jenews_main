            ...
            <form class="uk-grid-small uk-position-relative uk-grid" uk-grid action="{{ route('Article > Submit') }}"
                            ...
                            <div class="uk-grid">
                                <div class="uk-width-1-2@m">
                                    ...
                                    <div class="uk-alert-danger" uk-alert>
                                        <p><span uk-icon="youtube"></span> در صورتی که نوع خبر فیلم می‌باشد، از بخش تصویر نوشته در سمت چپ ویدیو خود را انتخاب نمایید.</p>
                                    </div>
                                </div>
                                <div class="uk-width-1-2@m">
                                    <!-- article writer -->
                ...
                <div class="uk-width-1-3@m column uk-margin-small-bottom">
                    ...
                    <div class="uk-container uk-margin-medium">
                        <label><input class="uk-checkbox" name="action_send_telegram" id="action_send_telegram" type="checkbox" disabled> ارسال خبر به تلگرام</label>
                        <div class="uk-alert uk-alert-warning"><span uk-icon="warning"></span> ارسال به تلگرام غیرفعال می‌باشد.</div>
                    </div>
                    ...
                    <div class="uk-container">
                        ...
                        <ul uk-accordion class="uk-disabled">
                            <li class="uk-close">
                                <a class="uk-accordion-title" href="#">افزودن دسته <span class="uk-text-meta">(غیرفعال)</span></a>
                    ...
                    <div class="uk-container">
                        ...
                        @include('admin.template-parts.Select2Dotjs')
                    ...
                    <div class="uk-container">
                        <div class="uk-card uk-card-secondary uk-card-body uk-border-rounded">
                            <h4 class="uk-h4 tm-heading-fragment">تصویر خبر</h4>
                            ...
                            <div uk-grid>
                                ...
                                <div class="input-group-append uk-width-auto">
