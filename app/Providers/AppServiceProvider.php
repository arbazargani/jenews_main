    ...
    public function boot()
    {
        ...
        if (Cache::has('newspaper_latest')) {
         ...
         if (Cache::has('latestArticles')) {
             ...
             $latestArticles = Article::where('created_at', '<=', Carbon::now())->where('state', 1)->limit(20)->latest()->get();
        ...
        if (Cache::has('popularArticles')) {
             ...
             $popularArticles = Article::where('state', 1)->where('created_at','<=', Carbon::now())
                 ...
                 ->where('created_at', '<=', Carbon::now())
                 ->whereBetween('created_at', [Carbon::now()->subDays(3), Carbon::now()])->orderBy('views', 'desc')->limit(20)->get();
         ...
         if (Cache::has('notPopularArticles')) {
             ...
             $notPopularArticles = Article::where('state', 1)->where('created_at','<=', Carbon::now())->whereBetween('created_at', [Carbon::now()->subDays(3), Carbon::now()])->orderBy('views', 'asc')->limit(20)->get();
